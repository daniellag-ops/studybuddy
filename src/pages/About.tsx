...
const WHY = [
  { emoji: '🎯', title: 'בנינו את זה גם בשבילנו', body: 'בנינו את זה גם בשבילנו. בתור תלמידים, אנחנו מבינים את הלחץ והקושי יותר מכל מבוגר אחר. הפתרון שלנו מגיע מתוך הרצון שלנו.' },
