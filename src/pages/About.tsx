...
const WHY = [
  { emoji: '🎯', title: 'תכל\'ס, בנינו את זה בשבילנו', body: 'בנינו את זה גם בשבילנו. בתור תלמידים, אנחנו מבינים את הלחץ והקושי יותר מכל מבוגר אחר. הפתרון שלנו מגיע מתוך הרצון שלנו.' },
